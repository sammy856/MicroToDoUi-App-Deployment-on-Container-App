...
# connection_string = os.getenv("CONNECTION_STRING", "Driver={ODBC Driver 17 for SQL Server};Server=tcp:sammy-sql-database.database.windows.net,1433;Database=sql-db;Uid=sqluser;Pwd=Sammy@078612;Encrypt=yes;TrustServerCertificate=yes;Connection Timeout=30;")
